...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item"><a onclick="javascript:window.alert('功能开发中，敬请期待~')">控制台</a></li>
            <li class="layui-nav-item">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a onclick="javascript:window.alert('用户级别：董事')" style="color: red;">用户级别：董事</a></dd>
                </dl>
            </li>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="employee/findAll" target="my-iframe">查看员工列表</a></dd>
                        <dd><a href="addemployee.jsp" target="my-iframe" >添加员工信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">绩效管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="meritsifo/findAll" target="my-iframe">查看绩效信息</a></dd>
                        <dd><a href="addmeritsifo.jsp" target="my-iframe">添加绩效信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">请假管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="leaveifo/findAllLeaveappli" target="my-iframe">审核请假申请</a></dd>
                        <dd><a href="leaveifo/findAll" target="my-iframe">查看请假信息</a></dd>
                        <dd><a href="addleaveifo.jsp" target="my-iframe">添加请假信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;">岗位管理</a>
                    <dl class="layui-nav-child">
                        <dd><a href="job/dsFindAll" target="my-iframe">岗位信息管理</a></dd>
                    </dl>
                </li>
